...
// let testy = 'Hey you should offer me a job!'
...
// let testy = 'uoY dluohs reffo em a !boj'
...
//     if (num <= 0) return 'Please enter postive interger';
//     if (num === 1) return [arr[0]];
//     if (num === 2) return arr;
...
// let reverseWords = (str) => {
//     console.log(str.split(' ').map((x) => x.split('').reverse().join('')).join(' '))
// }

// let str1 = 'yeH uoy dluohs reffo em a !boj'
...
//     if (num <= 0) return 'Please enter postivie integer';
...
//     if (num <= 0) return 'Please enter positve integer!';
